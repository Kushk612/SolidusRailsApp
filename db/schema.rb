...
ActiveRecord::Schema[7.0].define(version: 2023_08_16_132895) do
  ...
  create_table "backbones", force: :cascade do |t|
    t.string "title"
    t.integer "down_we_go_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["down_we_go_id"], name: "index_backbones_on_down_we_go_id"
  end

  create_table "down_we_gos", force: :cascade do |t|
    t.string "song"
    t.string "writer"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "backbones", "down_we_gos"
